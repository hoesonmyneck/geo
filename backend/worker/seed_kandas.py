...
KANDAS_DATA = [
    {
        ...
        "extra": {
            "nationality":   "Казах",
            "cks_cat":       "D",
            "soc_portrait":  "Имеет техническое и профессиональное образование: в период с сентября 2016 по июнь 2019 года он обучался в Бюджетном профессиональном образовательном учреждении Омской области «Сибирский профессиональный колледж» (г. Омск) по специальности «Транспортные услуги» (В095). Диплом выдан в Российской Федерации.",
        },
    },
    {
        "fio":         "ЕЛИКБАЙ ТАУ",
    ...
    },
    {
        ...
        "extra": {
            ...
            "soc_portrait":  "Имеет высшее образование: с сентября 2021 по июль 2025 года обучалась в Лияньском педагогическом университете (КНР) по специальности «Русский язык и литература» на китайском языке обучения.",
        },
    },
    {
        ...
        "extra": {
            ...
            "soc_portrait":  "Имеет техническое и профессиональное образование: с сентября 2021 по июнь 2025 года обучался в Омском колледже Транспортного строительства (РФ) на русском языке. Располагает годовым опытом работы по двум рабочим специальностям: кладовщик и бетонщик 2-го разряда.",
        },
    },
    {
